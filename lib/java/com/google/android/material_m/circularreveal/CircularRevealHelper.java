 ...
 */
package com.google.android.material_m.circularreveal;

import static com.google.android.material_m.math.MathUtils.DEFAULT_EPSILON;
...
public class CircularRevealHelper {
   ...
   *
   * <p>A non-null RevealInfo is {@link CircularRevealWidget.RevealInfo#isInvalid() invalid} if a circular reveal is
   * active and the circular reveal does not cover all four corners of this view. When the circular
   * reveal is such that it covers the entire view, {@link CircularRevealWidget.RevealInfo#radius} should be set to
   * {@link CircularRevealWidget.RevealInfo#INVALID_RADIUS}, making the RevealInfo invalid. An invalid RevealInfo is a
   * optimization that allows {@link #draw(Canvas)} to use the fastest code path.
   */
  @Nullable private CircularRevealWidget.RevealInfo revealInfo;
   ...
   * entire View has its {@link CircularRevealWidget.RevealInfo#radius} set to {@link CircularRevealWidget.RevealInfo#INVALID_RADIUS}.
   */
  public void setRevealInfo(@Nullable CircularRevealWidget.RevealInfo revealInfo) {
    if (revealInfo == null) {
      ...
      if (MathUtils.geq(
        ...
        this.revealInfo.radius = CircularRevealWidget.RevealInfo.INVALID_RADIUS;
      }
    }
