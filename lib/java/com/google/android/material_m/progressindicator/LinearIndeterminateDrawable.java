...
package com.google.android.material_m.progressindicator;
...
import com.google.android.material_m.animation.AnimationUtils;
import com.google.android.material_m.math.MathUtils;
...
class LinearIndeterminateDrawable extends DrawableWithAnimatedVisibilityChange
  ...
  private static final long MAIN_LINE_1_HEAD_DURATION = (long) (750 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long MAIN_LINE_1_TAIL_DELAY = (long) (333 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long MAIN_LINE_1_TAIL_DURATION = (long) (850 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long MAIN_LINE_2_HEAD_DELAY = (long) (1000 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long MAIN_LINE_2_HEAD_DURATION = (long) (567 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long MAIN_LINE_2_TAIL_DELAY = (long) (1267 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long MAIN_LINE_2_TAIL_DURATION = (long) (533 * ProgressIndicator.ANIMATION_SPEED_FACTOR);

  private static final long SEAMLESS_NEXT_COLOR_DELAY = (long) (333 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long SEAMLESS_DURATION_PER_COLOR = (long) (667 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
