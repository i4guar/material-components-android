...
class CircularIndeterminateDrawable extends DrawableWithAnimatedVisibilityChange
  ...
  private static final long DURATION_PER_COLOR_IN_MS = (long) (1333 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long COLOR_FADING_DURATION = (long) (333 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
  private static final long COLOR_FADING_DELAY = (long) (1000 * ProgressIndicator.ANIMATION_SPEED_FACTOR);
