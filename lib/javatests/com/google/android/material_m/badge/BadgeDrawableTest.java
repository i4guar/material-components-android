...
public class BadgeDrawableTest {
  ...
  public void testSavedState() {
    ...
    BadgeDrawable.SavedState drawableState = badgeDrawable.getSavedState();
    ...
    BadgeDrawable.SavedState createdFromParcel = BadgeDrawable.SavedState.CREATOR.createFromParcel(parcel);
